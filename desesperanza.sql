...
CREATE TABLE `compra_insumos` (
  ...
  CONSTRAINT `compra_insumos_ibfk_1` FOREIGN KEY (`id_prov`) REFERENCES `proveedores` (`id_prov`),
  CONSTRAINT `compra_insumos_ibfk_2` FOREIGN KEY (`id_insumos`) REFERENCES `insumos` (`id_insumos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detalle_pedido` (
  ...
  CONSTRAINT `detalle_pedido_ibfk_2` FOREIGN KEY (`id_pro`) REFERENCES `productos` (`id_pro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inventario` (
  ...
  PRIMARY KEY (`id_inv`),
  KEY `id_pro` (`id_pro`),
  CONSTRAINT `inventario_ibfk_1` FOREIGN KEY (`id_pro`) REFERENCES `productos` (`id_pro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `clientes` (`id_client`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-30 23:52:35
